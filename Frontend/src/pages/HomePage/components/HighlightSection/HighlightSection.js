...
function HighlightSection({ source }) {
  return (
    <div className={cx("container")}>
      <div className={cx("information")}>
        ...
        <div className={cx("overview")}>
          <span className={cx("overview-text")}>{source?.overview}</span>
        </div>
        <div className={cx("button-group")}>
          ...
          <Link
            ...
            to={"/" + source?.type + "/detail/" + source?.id}
          >
            More Details
          </Link>
        </div>
