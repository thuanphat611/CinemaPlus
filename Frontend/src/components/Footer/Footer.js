    ...
    <div>
      ...
      <div className={cx("container")}>
        <div className={cx("content")}>
          <div className={cx("introduction")}>
            ...
            <h4 className={cx("title")}>
              Your {/*Free*/} Ticket to Endless Entertainment
            </h4>
            <p className={cx("introduction-text")}>
              CinemaPlus is your ultimate destination for streaming movies and
              TV series. Dive into a vast library of genres, discover new
              releases, and enjoy high-quality entertainment anytime, anywhere.
              Elevate your viewing experience with personalized recommendations,
              exclusive content, and seamless streaming on all your devices with
              CinemaPlus.
            </p>
          </div>
          <div className={cx("downloads")}>
            ...
            <div className={cx("download-blocks")}>
              ...
              <div className={cx("block")}>
                ...
                >
                  <img
                    className={cx("microsoft-store-icon")}
                    src={microsoftStore}
                    alt=""
                  />
                  <h4 className={cx("microsoft-store-text")}>
                    Microsoft Store
                  </h4>
                </a>
              </div>
              <div className={cx("block")}>
                <a
                  className={cx("email-contact")}
                  href="mailto:cinemaplus.contact@gmail.com"
                  rel="noreferrer"
                  target="_blank"
                >
                  <IoIosMail />
        ...
        <div className={cx("credit")}>
          <p className={cx("credit-text")}>
            The orginal design idea can be found
            <a
              className={cx("design-link")}
              href="https://dribbble.com/shots/24037692-Movie-Website-Case-Study"
              rel="noreferrer"
              target="_blank"
            >
              here
